            ...
            <section class="content">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title"> Agregar un Nuevo Usuario </h3>
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    @if ($message = Session::get('Listo'))
                                        <div class="alert alert-success alert-dismissable fade show col-12"
                                            role="alert">
                                            <h5>Listo</h5>
                                            <p>{{ $message }}</p>
                                        </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <button class="btn btn-primary btnEdit"
                                                            ...
                                                            data-idioma="{{ $p->Idioma }}"
                                                            data-subtitulos="{{ $p->Subtitulos }}"
                ...
                <form action="/admin/peliculas/edit" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-border" id="nombreEdit" name="nombre"
                                value="{{ @old('nombre') }}">
                        </div>
                        <div class="form-group">
                            <label for="idiomas">Idioma</label>
                            <input type="text" class="form-control form-control-border" id="idiomaEdit" name="idiomas"
                                value="{{ @old('idiomas') }}">
                        </div>
                        <div class="form-group">
                            <label for="subtitulos">Subtitulos</label>
                            <input type="text" class="form-control form-control-border" id="subtitulosEdit" min="1"
                                name="subtitulos" value="{{ @old('subtitulos') }}">
                        </div>
                        <div class="form-group">
                            <label for="director">Director</label>
                            <input type="text" class="form-control form-control-border" id="directorEdit" min="1"
                                name="director" value="{{ @old('director') }}">
                        </div>
                        <div class="form-group">
                            <label for="fecha">Fecha</label>
                            <input type="date" class="form-control form-control-border" id="fechaEdit" min="1"
                                name="fecha" value="{{ @old('fecha') }}">
                        </div>
                        <div class="form-group">
                            <label for="descripcion">Descripcion</label>
                            <input type="text" class="form-control form-control-border" id="descripcionEdit" min="1"
